...
import ma.bettach_nada.exam_jee.service.RemboursementService;
import ma.bettach_nada.exam_jee.util.CustomCollectors;
...
public class RemboursementResource {
    ...
    public ResponseEntity<Map<Long, String>> getCreditValues() {
        return ResponseEntity.ok(creditRepository.findAll(Sort.by("id"))
                .stream()
                .collect(CustomCollectors.toSortedMap(Credit::getId, Credit::getCreditType)));
    }
